// ======================================================================
// Kisrobot.v generated from TopDesign.cysch
// 05/08/2023 at 17:27
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=127, CompareValue2=63, CONTROL3=1, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=true, FixedFunction=true, FixedFunctionUsed=1, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=1, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=255, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=true, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_R, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_R, CY_INSTANCE_SHORT_NAME=PWM_R, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=PWM_R, )
module PWM_v3_30_1 (
    reset,
    clock,
    tc,
...
// Counter_v3_0(CaptureMode=3, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=65533, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=true, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=65534, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=true, ReloadOnOverUnder=false, ReloadOnReset=false, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Counter_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Counter_1, CY_INSTANCE_SHORT_NAME=Counter_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=Counter_1, )
...
module top ;
	...
	cy_clock_v1_0
		#(.id("aeacf20d-7fcc-46ce-ad5a-eb931d249528"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__MOT_L_net;
	wire [0:0] tmpFB_0__MOT_L_net;
	wire [0:0] tmpIO_0__MOT_L_net;
	wire [0:0] tmpINTERRUPT_0__MOT_L_net;
	electrical [0:0] tmpSIOVREF__MOT_L_net;
	...
	cy_psoc3_pins_v1_10
		...
		MOT_L
		 (.oe(tmpOE__MOT_L_net),
		  .y({Net_379}),
		  .fb({tmpFB_0__MOT_L_net[0:0]}),
		  .io({tmpIO_0__MOT_L_net[0:0]}),
		  .siovref(tmpSIOVREF__MOT_L_net),
		  .interrupt({tmpINTERRUPT_0__MOT_L_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MOT_L_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MOT_R_net;
	wire [0:0] tmpFB_0__MOT_R_net;
	wire [0:0] tmpIO_0__MOT_R_net;
	wire [0:0] tmpINTERRUPT_0__MOT_R_net;
	electrical [0:0] tmpSIOVREF__MOT_R_net;

	cy_psoc3_pins_v1_10
		#(.id("0fc0c978-66e4-4ec5-b0f4-e903df91e6af"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		MOT_R
		 (.oe(tmpOE__MOT_R_net),
		  .y({Net_383}),
		  .fb({tmpFB_0__MOT_R_net[0:0]}),
		  .io({tmpIO_0__MOT_R_net[0:0]}),
		  .siovref(tmpSIOVREF__MOT_R_net),
		  .interrupt({tmpINTERRUPT_0__MOT_R_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MOT_R_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("60086ef0-ec79-4e45-b9e9-7144e8ee7052"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Left_mot_dir_net;
	wire [0:0] tmpFB_0__Left_mot_dir_net;
	wire [0:0] tmpIO_0__Left_mot_dir_net;
	wire [0:0] tmpINTERRUPT_0__Left_mot_dir_net;
	electrical [0:0] tmpSIOVREF__Left_mot_dir_net;

	cy_psoc3_pins_v1_10
		#(.id("77fd025d-2686-48ba-ad3a-d49f5c6171f5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Left_mot_dir
		 (.oe(tmpOE__Left_mot_dir_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Left_mot_dir_net[0:0]}),
		  .io({tmpIO_0__Left_mot_dir_net[0:0]}),
		  .siovref(tmpSIOVREF__Left_mot_dir_net),
		  .interrupt({tmpINTERRUPT_0__Left_mot_dir_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Left_mot_dir_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Right_mot_dir_net;
	wire [0:0] tmpFB_0__Right_mot_dir_net;
	wire [0:0] tmpIO_0__Right_mot_dir_net;
	wire [0:0] tmpINTERRUPT_0__Right_mot_dir_net;
	electrical [0:0] tmpSIOVREF__Right_mot_dir_net;

	cy_psoc3_pins_v1_10
		#(.id("1cce433f-e842-4f9a-85b9-40ea9052b772"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Right_mot_dir
		 (.oe(tmpOE__Right_mot_dir_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Right_mot_dir_net[0:0]}),
		  .io({tmpIO_0__Right_mot_dir_net[0:0]}),
		  .siovref(tmpSIOVREF__Right_mot_dir_net),
		  .interrupt({tmpINTERRUPT_0__Right_mot_dir_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Right_mot_dir_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("6d9cfc7e-a4ba-4a1f-867d-1d9c20a114e1"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    CyControlReg_v1_80 Reg_PWM_Start (
        .control_1(Net_382),
        .control_2(Net_338),
        .control_3(Net_339),
        .control_0(Net_289),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Reg_PWM_Start.Bit0Mode = 0;
    defparam Reg_PWM_Start.Bit1Mode = 0;
    defparam Reg_PWM_Start.Bit2Mode = 0;
    defparam Reg_PWM_Start.Bit3Mode = 0;
    defparam Reg_PWM_Start.Bit4Mode = 0;
    defparam Reg_PWM_Start.Bit5Mode = 0;
    defparam Reg_PWM_Start.Bit6Mode = 0;
    defparam Reg_PWM_Start.Bit7Mode = 0;
    defparam Reg_PWM_Start.BitValue = 0;
    defparam Reg_PWM_Start.BusDisplay = 0;
    defparam Reg_PWM_Start.ExtrReset = 0;
    defparam Reg_PWM_Start.NumOutputs = 2;
    ...
    defparam Counter_1.ReloadOnCompare = 1;
	...
	wire [0:0] tmpOE__US_echo_net;
	wire [0:0] tmpIO_0__US_echo_net;
	wire [0:0] tmpINTERRUPT_0__US_echo_net;
	electrical [0:0] tmpSIOVREF__US_echo_net;

	cy_psoc3_pins_v1_10
		#(.id("fef35556-f858-4c0f-8070-13467c95b06b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		US_echo
		 (.oe(tmpOE__US_echo_net),
		  .y({1'b0}),
		  .fb({Net_420}),
		  .io({tmpIO_0__US_echo_net[0:0]}),
		  .siovref(tmpSIOVREF__US_echo_net),
		  .interrupt({tmpINTERRUPT_0__US_echo_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__US_echo_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    assign Net_414 = 1'h0;


	cy_clock_v1_0
		#(.id("12d4118a-86bd-45d6-82ec-4a1a391b2c48"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__US_trig_net;
	wire [0:0] tmpFB_0__US_trig_net;
	wire [0:0] tmpIO_0__US_trig_net;
	wire [0:0] tmpINTERRUPT_0__US_trig_net;
	electrical [0:0] tmpSIOVREF__US_trig_net;

	cy_psoc3_pins_v1_10
		#(.id("26a698a2-83e0-415b-82cc-a8e418803193"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		US_trig
		 (.oe(tmpOE__US_trig_net),
		  .y({Net_415}),
		  .fb({tmpFB_0__US_trig_net[0:0]}),
		  .io({tmpIO_0__US_trig_net[0:0]}),
		  .siovref(tmpSIOVREF__US_trig_net),
		  .interrupt({tmpINTERRUPT_0__US_trig_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__US_trig_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("5ba9fd40-2c5e-4dfb-b82d-76fbac69dbdb"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("21aa0ef5-cf41-47b5-b14a-37e1c9a6c2c2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bdd7e18f-f27b-4e9c-97e9-5e5f72e9e113"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
